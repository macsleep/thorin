...
*	OPT	CRE
	...
	INCLUDE	"Basic68.inc"			* RAM offset definitions

	ORG		$000600			* past the vectors in a real system
...
* in d0, for now we fake that with these extra move instructions
	...
	MOVEA.l	#$4000,a0			* tell BASIC where RAM is
	MOVE.l	#$4000,d0			* tell BASIC how big RAM is
